...
# test_instruction = "Write a 6000 word piece on the HBO TV show WestWorld and its plot, characters, and themes. \
...
test_instruction = """Write a comprehensive legal qualification of the criminal case involving [ФИО обвиняемого], based on the materials of the criminal case, 
relevant legislation, and judicial practice. The total text should be no less than 5000 words."""

# Run the workflow
inputs = {"initial_prompt": test_instruction,  
          "num_steps": 0,
          "llm_name": "Nemo-12B-q8"}
